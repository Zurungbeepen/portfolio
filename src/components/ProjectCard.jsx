export default function ProjectCard({ name, description, stack, github }) {
  return (
    <div className="bg-surface border border-white/5 rounded-2xl p-6 flex flex-col gap-4 hover:border-accent/30 hover:shadow-xl hover:shadow-accent/5 transition-all duration-300">
      ...
      <a
        ...
        className="flex items-center gap-2 text-sm text-muted hover:text-accent transition-colors duration-200 mt-1"
      >
